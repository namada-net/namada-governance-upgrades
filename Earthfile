...
source:
  ...
  COPY --keep-ts --dir phase2 phase3 phase4 phase5a phase5b pre-phase4 update_ibc_rate_limits increase_target_staked_ratio update-wasm hf_cosmos_unlimited_channel ./
